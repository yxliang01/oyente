...
def sym_exec_block(params, block, pre_block, depth, func_call, current_func_name):
    ...
    if jump_type[block] == "terminal" or depth > global_params.DEPTH_LIMIT:
        ...
        if global_params.OUTPUT_PATH_GAS:
            current_gas_used = simplify(current_gas_used, flat=True, mul_to_power=True, som=True, sort_sums=True, cache_all=True)
